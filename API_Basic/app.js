...
function searchFunction(page =1) {
    ...
    if (searchValue.trim()) getSearchApiResponse(sigunguId, cat1, cat2, cat3, itemCount, arrangeId, searchValue, page);
    else getApiResponse(sigunguId, contentTypeId, cat1, cat2, cat3, itemCount, arrangeId, page);
}
//모달에서 id추출
